...
Gem::Specification.new do |spec|
  ...
  spec.files         = ["lib/mozart/cli.rb", "lib/mozart/symphony.rb", "lib/mozart/scraper.rb", "lib/symphonies.rb", "config/environment.rb", "bin/mozart-symphonies", "lib/mozart/version.rb"]
